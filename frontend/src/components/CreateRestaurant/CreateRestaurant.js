            ...
            <div className="align-self-center d-flex flex-column">
              ...
              onChange={(e) =>{
                ...
                <div className="input-group mb-3 modal_container">
                    ...
                    <input type="text" className="form-control w-100" aria-describedby="phone_number" required=""  {...formik.getFieldProps("phone")}></input>
                </div>
            </div>
            <button className="btn btn-primary mt-3 align-self-center mb-3" type="submit">Create</button>
            </form>
        </div> 
    )
}
