  ...
  return (
    <div>
      <div className="d-flex flex-row">
        <h1>Comments</h1>
        <Button
          className="mt-auto mb-auto ms-auto me-3"
          onClick={() => {
            setShowComment(true);
          }}
        >
      ...
      <AddComment
        CommentShow={showComment}
        SetCommentShow={setShowComment}
...
const AddComment = (props) => {
  ...
  return (
    <Modal
      ...
      onHide={() => props.SetCommentShow(false)}
      backdrop="static"
      centered
    >
      <Modal.Header closeButton>
      ...
      <form onSubmit={formik.handleSubmit} className="d-flex flex-column">
        ...
        <Button type="submit" className="ms-auto me-auto mb-1">
          Submit
        </Button>
      </form>
    </Modal>
